...
class AttentionDataGenerator(DataGenerator):
    def __init__(self, filename, batch_size, stride, pe_encoder_max_length, pe_decoder_max_length):
        super().__init__(filename, batch_size, stride, input_length=pe_encoder_max_length, reads_count=5, use_maxpool=False, rnn_pad_size=0)
