import numpy as np
from utils.preprocessing.DataBuffer import DataBuffer
from utils.Other import labelBaseMap

class DataGenerator():
    
    def __init__(self, filename, batch_size, stride, input_length, reads_count, use_maxpool, rnn_pad_size=0):
        ...
        self._buffer = DataBuffer(filename, size=reads_count)
        self._batch_count = 0
